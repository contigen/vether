    ...
    200: {
        ...
        items: Array<{
            ...
            llm: {
                 ...
                 */
                model?: 'gpt-4o' | 'claude-3-5-haiku-latest' | 'claude-3-7-sonnet-latest' | 'claude-4-sonnet-20250514' | 'grok-3-latest' | 'grok-4-latest' | 'deepseek-chat' | 'o3-mini' | 'gpt-4o-mini' | 'asi1-mini' | 'targon-gpt-oss-120b' | 'gpt-5' | 'gpt-5-mini' | 'gpt-5-nano' | 'gemini-2.5-flash' | 'gemini-2.5-pro' | 'grok-2-latest' | 'grok-3-beta';
                /**
...
export type GetV1UsersMeUsageData = {
    body?: never;
    headers?: {
        'X-API-Version'?: string;
    };
...
export type GetV1UsersMeUsageErrors = {
    /**
     * Bad Request
     */
    400: {
...
export type GetV1UsersMeUsageError = GetV1UsersMeUsageErrors[keyof GetV1UsersMeUsageErrors];

export type GetV1UsersMeUsageResponses = {
    /**
     * Usage metrics
     */
    200: {
...
export type GetV1UsersMeUsageResponse = GetV1UsersMeUsageResponses[keyof GetV1UsersMeUsageResponses];
...
export type GetV1ReplicasByReplicaUuidKnowledgeBaseData = {
    body?: never;
    headers?: {
        'X-API-Version'?: string;
    };
...
export type GetV1ReplicasByReplicaUuidKnowledgeBaseErrors = {
    /**
     * Bad Request
     */
    400: {
...
export type GetV1ReplicasByReplicaUuidKnowledgeBaseError = GetV1ReplicasByReplicaUuidKnowledgeBaseErrors[keyof GetV1ReplicasByReplicaUuidKnowledgeBaseErrors];

export type GetV1ReplicasByReplicaUuidKnowledgeBaseResponses = {
    /**
     * List of knowledge base entries returned successfully.
     */
    200: {
...
export type GetV1ReplicasByReplicaUuidKnowledgeBaseResponse = GetV1ReplicasByReplicaUuidKnowledgeBaseResponses[keyof GetV1ReplicasByReplicaUuidKnowledgeBaseResponses];

export type PostV1ReplicasByReplicaUuidKnowledgeBaseData = {
    body?: {
        /**
         * Title for this knowledge base entry. Helps identify the content in listings.
         */
...
export type PostV1ReplicasByReplicaUuidKnowledgeBaseErrors = {
    /**
     * Bad Request
     */
    400: {
...
export type PostV1ReplicasByReplicaUuidKnowledgeBaseError = PostV1ReplicasByReplicaUuidKnowledgeBaseErrors[keyof PostV1ReplicasByReplicaUuidKnowledgeBaseErrors];

export type PostV1ReplicasByReplicaUuidKnowledgeBaseResponses = {
    /**
     * The created knowledge base entry
     */
    207: {
...
export type PostV1ReplicasByReplicaUuidKnowledgeBaseResponse = PostV1ReplicasByReplicaUuidKnowledgeBaseResponses[keyof PostV1ReplicasByReplicaUuidKnowledgeBaseResponses];

export type DeleteV1ReplicasByReplicaUuidKnowledgeBaseByKnowledgeBaseIdData = {
    body?: never;
    headers?: {
        'X-API-Version'?: string;
    };
    path: {
         ...
         * The unique identifier of the knowledge base entry
         */
        knowledgeBaseID: KnowledgeBaseIdParameter & (number | null);
        /**
         * The replica unique identifier (UUID)
         */
        replicaUUID: ReplicaUuidParameter;
...
export type DeleteV1ReplicasByReplicaUuidKnowledgeBaseByKnowledgeBaseIdErrors = {
    /**
     * Knowledge base entry not found.
     */
    404: {
...
export type DeleteV1ReplicasByReplicaUuidKnowledgeBaseByKnowledgeBaseIdError = DeleteV1ReplicasByReplicaUuidKnowledgeBaseByKnowledgeBaseIdErrors[keyof DeleteV1ReplicasByReplicaUuidKnowledgeBaseByKnowledgeBaseIdErrors];

export type DeleteV1ReplicasByReplicaUuidKnowledgeBaseByKnowledgeBaseIdResponses = {
    /**
     * The knowledge base entry was deleted successfully.
     */
    200: {
...
export type DeleteV1ReplicasByReplicaUuidKnowledgeBaseByKnowledgeBaseIdResponse = DeleteV1ReplicasByReplicaUuidKnowledgeBaseByKnowledgeBaseIdResponses[keyof DeleteV1ReplicasByReplicaUuidKnowledgeBaseByKnowledgeBaseIdResponses];

export type GetV1ReplicasByReplicaUuidKnowledgeBaseByKnowledgeBaseIdData = {
    body?: never;
    headers?: {
        'X-API-Version'?: string;
    };
...
export type GetV1ReplicasByReplicaUuidKnowledgeBaseByKnowledgeBaseIdErrors = {
    /**
     * Bad Request
     */
    400: {
...
export type GetV1ReplicasByReplicaUuidKnowledgeBaseByKnowledgeBaseIdError = GetV1ReplicasByReplicaUuidKnowledgeBaseByKnowledgeBaseIdErrors[keyof GetV1ReplicasByReplicaUuidKnowledgeBaseByKnowledgeBaseIdErrors];

export type GetV1ReplicasByReplicaUuidKnowledgeBaseByKnowledgeBaseIdResponses = {
    /**
...
export type GetV1ReplicasByReplicaUuidKnowledgeBaseByKnowledgeBaseIdResponse = GetV1ReplicasByReplicaUuidKnowledgeBaseByKnowledgeBaseIdResponses[keyof GetV1ReplicasByReplicaUuidKnowledgeBaseByKnowledgeBaseIdResponses];

export type PatchV1ReplicasByReplicaUuidKnowledgeBaseByKnowledgeBaseIdData = {
    body?: {
        /**
...
export type PatchV1ReplicasByReplicaUuidKnowledgeBaseByKnowledgeBaseIdErrors = {
    /**
     * Bad Request
     */
    400: {
...
export type PatchV1ReplicasByReplicaUuidKnowledgeBaseByKnowledgeBaseIdError = PatchV1ReplicasByReplicaUuidKnowledgeBaseByKnowledgeBaseIdErrors[keyof PatchV1ReplicasByReplicaUuidKnowledgeBaseByKnowledgeBaseIdErrors];

export type PatchV1ReplicasByReplicaUuidKnowledgeBaseByKnowledgeBaseIdResponses = {
    /**
     * Knowledge base entry updated successfully.
     */
    200: {
...
export type PatchV1ReplicasByReplicaUuidKnowledgeBaseByKnowledgeBaseIdResponse = PatchV1ReplicasByReplicaUuidKnowledgeBaseByKnowledgeBaseIdResponses[keyof PatchV1ReplicasByReplicaUuidKnowledgeBaseByKnowledgeBaseIdResponses];

export type GetV1KnowledgeBaseFileTypesData = {
    body?: never;
    headers?: {
        'X-API-Version'?: string;
    };
...
export type GetV1KnowledgeBaseFileTypesErrors = {
    /**
     * Bad Request
     */
    400: {
...
export type GetV1KnowledgeBaseFileTypesError = GetV1KnowledgeBaseFileTypesErrors[keyof GetV1KnowledgeBaseFileTypesErrors];

export type GetV1KnowledgeBaseFileTypesResponses = {
    /**
...
export type GetV1KnowledgeBaseFileTypesResponse = GetV1KnowledgeBaseFileTypesResponses[keyof GetV1KnowledgeBaseFileTypesResponses];
